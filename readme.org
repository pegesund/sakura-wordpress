...
#+BEGIN_SRC sh
for wp in /usr/share/webapps/wordpress/wp-content/plugins /data/sakura/shops/shop1/html/wp-content/plugins /data/sakura/shops/shop2/html/wp-content/plugins
do
		echo setup sakura in $wp
		sudo mkdir -p $wp/sakura
		sudo mkdir -p $wp/sakura-dev
		echo cp to $wp/sakura-dev/
