...
- [[#implementation-of-main-class][Implementation of main class]]
  ...
  - [[#store-sitearticle-from-sakura-network-in-local-cookies][store site/article from Sakura network in local cookies.]]
...
** store site/article from Sakura network in local cookies.
#+BEGIN_SRC php
    /**
